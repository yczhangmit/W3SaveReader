...
using System.Linq;
using System.Text;
using W3SaveReader.ChunkedLz4;
using W3SaveReader.Exceptions;
using W3SaveReader.Savegame.Values;
using W3SaveReader.Savegame.VariableParsers;
using W3SaveReader.Savegame.Variables;

namespace W3SaveReader.Savegame
{
    ...
    public class SavegameFile
    {
        ...
        public static SavegameFile Read(string path)
        {
            ...
            using (var reader = new BinaryReader(inputStream, Encoding.ASCII, true))
            {
                ...
                savegameFile.ReferenceVariable(reader);
                return savegameFile;
            }
        }
        ...
        private void ReferenceVariable(BinaryReader reader)
        {
